...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(252, 163, 17));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 300, 300));
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ...
        String pass ;
        try{
            String sql ="SELECT `Password` FROM `register` WHERE User_Name= '"+txtuid.getText()+"'";
