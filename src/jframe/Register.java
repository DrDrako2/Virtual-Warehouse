...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        update.setBackground(new java.awt.Color(252, 163, 17));
        ...
        update1.setBackground(new java.awt.Color(252, 163, 17));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 300, 460));
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        ...
        String reupdate = "UPDATE `register` SET `User_Name`=?,`Password`=?,`Re_Password`=? WHERE ID = '"+txtid.getText()+"'";
    ...
    private void id(){
    try{
            String sql ="SELECT `ID`, `User_Name`, `Password`, `Re_Password` FROM `register` WHERE ID= '"+txtid.getText()+"'";
            pat = con.prepareStatement(sql);
            rs = pat.executeQuery();
            if(rs.next())
            {
            txtuid.setText(rs.getString("User_Name"));
            txtpass.setText(rs.getString("Password"));
            txtrepass.setText(rs.getString("Re_Password"));
        }
        }
        catch(Exception e)
        {
